...
public class GsonUtil {
	...
	/**
	 * 根据分页对象生成json分页字符串，并返回
	 * 
	 * @param dp
	 * @return
	 */
	@SuppressWarnings("rawtypes")
	public static String getPageResultJsonString(DisplaytagPage dp) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("total", dp.getTotalPages());
		map.put("rows", dp.getList());
		map.put("customField", dp.getCustomField());
	 ...
	 * @return
	 */
	public static String getPageResultJsonString(Map<String, Object> map) {
		String j = gson.toJson(map);
		return j;
	}
	/**
	 * 根据分页对象和日期格式化参数生成json分页字符串，并返回
	 * 
	 * @param dp
	 * @return
	 */
	@SuppressWarnings("rawtypes")
	public static String getPageResultJsonString(DisplaytagPage dp, String datePattern) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("total", dp.getTotalPages());
		map.put("rows", dp.getList());
		String re = toJson(map, datePattern);
		return re;
	}
}
